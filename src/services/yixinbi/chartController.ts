...
export async function getChartByAiUsingPost(
  ...
  return request<API.BaseResponseAiResponseVO_>('/api/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function getChartByAiAsyncUsingPost(
  ...
  return request<API.BaseResponseAiResponseVO_>('/api/chart/gen/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function getChartByAiAsyncMqUsingPost(
  ...
  return request<API.BaseResponseAiResponseVO_>('/api/chart/gen/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
